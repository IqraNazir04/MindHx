...
// license requests.
export default function NatureBanner({ src, alt, photographerName, photographerUrl, caption }: Props) {
  return (
    <figure className="nature-banner">
      <Image src={src} alt={alt} width={1600} height={560} sizes="(max-width: 800px) 100vw, 1120px" />
